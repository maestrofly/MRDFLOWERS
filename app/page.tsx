...
export default function Home() {
  ...
  const heroSlides = [
    {
      ...
      desc: "Plants that bring peace, energy, and life into your home.",
      img: "/plants/evergreen.jpeg",
    },
    {
    ...
    },
    {
      ...
      desc: "Discover plants that connect you back to nature.",
      img: "/plants/pothosSIL.jpeg",
    },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* HERO CAROUSEL */}
      <section className="w-full bg-gradient-to-b from-green-50 to-white py-10 md:py-16">
            ...
            <CarouselContent>
              {heroSlides.map((slide, index) => (
                <CarouselItem key={index} className="basis-full">
                  <div className="relative overflow-hidden rounded-3xl h-[450px] md:h-[550px] flex items-center justify-center">
                    ...
                    <div className="relative text-center text-white space-y-4 px-6">
      ...
      <section className="py-16 md:py-24">
        <div className="container px-4 md:px-6 text-center space-y-10">
          ...
          <div>
            <div className="inline-flex items-center gap-2 text-green-700 bg-green-100 px-4 py-1 rounded-full text-sm">
              <Leaf className="h-4 w-4" />
              MRD FLOWERS EXPERIENCE
            </div>
            ...
            <p className="text-gray-500 max-w-2xl mx-auto mt-3">
              We combine nature, wellness, and spiritual harmony to help you build a living space that feels alive.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Simple, clear care instructions for every plant.",
              },
              {
                title: "Spiritual Meaning",
                desc: "Understand the energy and symbolism of plants.",
              },
              {
                title: "Space Placement",
                desc: "Learn where to place plants for best growth & energy.",
              },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-2">
              Explore our most loved plant collection
            </p>
          </div>
      ...
      <section className="py-20 text-center bg-gradient-to-b from-white to-green-50">
        <div className="container px-4 md:px-6 space-y-6">
          ...
          <h2 className="text-3xl md:text-5xl font-bold">
            Ready to Grow Your Space?
          </h2>

          <p className="text-gray-500 max-w-xl mx-auto">
            Start your journey with MRD FLOWERS and bring nature closer to your life.
          </p>

          <Button asChild className="bg-green-700 hover:bg-green-800 rounded-full px-8">
            <Link href="/plants">
